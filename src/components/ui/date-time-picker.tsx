        ...
        MonthCaption: ({ calendarMonth }) => {
          return (
            <div className="inline-flex py-1">
              ...
              >
                <SelectTrigger className="w-fit gap-1 border-none px-2 focus:bg-accent focus:text-accent-foreground">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {MONTHS.map((month) => (
...
const TimePicker = React.forwardRef<TimePickerRef, TimePickerProps>(
  ({ date, onChange, hourCycle = 24, granularity = 'second', hideIcon = false }, ref) => {
    ...
    return (
      <div className="flex items-center gap-2">
        <label htmlFor="datetime-picker-hour-input" className={cn("cursor-pointer", hideIcon ? 'hidden' : null)}>
